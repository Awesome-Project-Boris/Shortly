...
def lambda_handler(event, context):
    ...
    # --- Configuration ---
    # Fetch the bucket name from the same environment variable.
    ...
    try:
        ...
        # This could happen if the object doesn't exist, which is okay in a rollback.
        # Or it could be a permissions error.
